...
parseSignature :: Parser FState Block
parseSignature =
...
sigH, defH, axmH, thmH :: Parser FState [Char]
...
-- low-level
choose, caseHypo, affirm, assume, llDefn :: Parser FState Block
